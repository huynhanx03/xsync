...
//
// TODO(dlht): add sharded/per-P counters if Size or resize accounting becomes
// a hot path. The current scan is contention-free but O(number of bins).
...
func (idx *index[V]) validSlotCount() uint64 {
